...
import { getProductImage, API_BASE } from "../services/api";
...
/* ================================================================== */
function CoInput({ label, placeholder, value, onChange, error, touched, onBlur, type = "text", icon, full, maxLength }) {
...
export default function Cart() {
  ...
  const discountAmount = (() => {
    ...
    const val = Number(appliedCoupon.discountValue || appliedCoupon.offerValue || 0);
    const type = appliedCoupon.discountType || appliedCoupon.offertype || "flat";
